void logic() {
	...
	if (!okWall) {
		if (v1.x == sarpe.x - 1 || v1.x == sarpe.x - 2) {
			v1.x = sarpe.x - 3;
			okWall = true;
		}
		if (v1.x == sarpe.x + 1 || v1.x == sarpe.x + 2) {
		...
		if (v1.y == sarpe.y - 1 || v1.y == sarpe.y - 2) {
			v1.y = sarpe.y - 3;
			okWall = true;
		}
		if (v1.y == sarpe.y + 1 || v1.y == sarpe.y + 2) {
		...
		if (v2.x == sarpe.x - 1 || v2.x == sarpe.x - 2) {
			v2.x = sarpe.x - 3;
			okWall = true;
		}
		if (v2.x == sarpe.x + 1 || v2.x == sarpe.x + 2) {
		...
		if (v2.y == sarpe.y - 1 || v2.y == sarpe.y - 2) {
			v2.y = sarpe.y - 3;
			okWall = true;
		}
		if (v2.y == sarpe.y + 1 || v2.y == sarpe.y + 2) {
		...
		if (v3.x == sarpe.x - 1 || v3.x == sarpe.x - 2) {
			v3.x = sarpe.x - 3;
			okWall = true;
		}
		if (v3.x == sarpe.x + 1 || v3.x == sarpe.x + 2) {
		...
		if (v3.y == sarpe.y - 1 || v3.y == sarpe.y - 2) {
			v3.y = sarpe.y - 3;
			okWall = true;
		}
		if (v3.y == sarpe.y + 1 || v3.y == sarpe.y + 2) {
		...
		if (v4.x == sarpe.x - 1 || v4.x == sarpe.x - 2) {
			v4.x = sarpe.x - 3;
			okWall = true;
		}
		if (v4.x == sarpe.x + 1 || v4.x == sarpe.x + 2) {
		...
		if (v4.y == sarpe.y - 1 || v4.y == sarpe.y - 2) {
			v4.y = sarpe.y - 3;
			okWall = true;
		}
		if (v4.y == sarpe.y + 1 || v4.y == sarpe.y + 2) {
		...
		if (v5.x == sarpe.x - 1 || v5.x == sarpe.x - 2) {
			v5.x = sarpe.x - 3;
			okWall = true;
		}
		if (v5.x == sarpe.x + 1 || v5.x == sarpe.x + 2) {
		...
		if (v5.y == sarpe.y - 1 || v5.y == sarpe.y - 2) {
			v5.y = sarpe.y - 3;
			okWall = true;
		}
		if (v5.y == sarpe.y + 1 || v5.y == sarpe.y + 2) {
		...
		if (v6.x == sarpe.x - 1 || v6.x == sarpe.x - 2) {
			v6.x = sarpe.x - 3;
			okWall = true;
		}
		if (v6.x == sarpe.x + 1 || v6.x == sarpe.x + 2) {
		...
		if (v6.y == sarpe.y - 1 || v6.y == sarpe.y - 2) {
			v6.y = sarpe.y - 3;
			okWall = true;
		}
		if (v6.y == sarpe.y + 1 || v6.y == sarpe.y + 2) {
		...
		if (v7.x == sarpe.x - 1 || v7.x == sarpe.x - 2) {
			v7.x = sarpe.x - 3;
			okWall = true;
		}
		if (v7.x == sarpe.x + 1 || v7.x == sarpe.x + 2) {
		...
		if (v7.y == sarpe.y - 1 || v7.y == sarpe.y - 2) {
			v7.y = sarpe.y - 3;
			okWall = true;
		}
		if (v7.y == sarpe.y + 1 || v7.y == sarpe.y + 2) {
		...
		if (v8.x == sarpe.x - 1 || v8.x == sarpe.x - 2) {
			v8.x = sarpe.x - 3;
			okWall = true;
		}
		if (v8.x == sarpe.x + 1 || v8.x == sarpe.x + 2) {
		...
		if (v8.y == sarpe.y - 1 || v8.y == sarpe.y - 2) {
			v8.y = sarpe.y - 3;
			okWall = true;
		}
		if (v8.y == sarpe.y + 1 || v8.y == sarpe.y + 2) {
		...
		if (v9.x == sarpe.x - 1 || v9.x == sarpe.x - 2) {
			v9.x = sarpe.x - 3;
			okWall = true;
		}
		if (v9.x == sarpe.x + 1 || v9.x == sarpe.x + 2) {
		...
		if (v9.y == sarpe.y - 1 || v9.y == sarpe.y - 2) {
			v9.y = sarpe.y - 3;
			okWall = true;
		}
		if (v9.y == sarpe.y + 1 || v9.y == sarpe.y + 2) {
		...
		if (v10.x == sarpe.x - 1 || v10.x == sarpe.x - 2) {
			v10.x = sarpe.x - 3;
			okWall = true;
		}
		if (v10.x == sarpe.x + 1 || v10.x == sarpe.x + 2) {
		...
		if (v10.y == sarpe.y - 1 || v10.y == sarpe.y - 2) {
			v10.y = sarpe.y - 3;
			okWall = true;
		}
		if (v10.y == sarpe.y + 1 || v10.y == sarpe.y + 2) {
...
void logic2() {
	...
	if (!okWall2) {
		if (v1.x == sarpe2.x - 1 || v1.x == sarpe2.x - 2) {
			v1.x = sarpe2.x - 3;
			okWall2 = true;
		}
		if (v1.x == sarpe2.x + 1 || v1.x == sarpe2.x + 2) {
		...
		if (v1.y == sarpe2.y - 1 || v1.y == sarpe2.y - 2) {
			v1.y = sarpe2.y - 3;
			okWall2 = true;
		}
		if (v1.y == sarpe2.y + 1 || v1.y == sarpe2.y + 2) {
		...
		if (v2.x == sarpe2.x - 1 || v2.x == sarpe2.x - 2) {
			v2.x = sarpe2.x - 3;
			okWall2 = true;
		}
		if (v2.x == sarpe2.x + 1 || v2.x == sarpe2.x + 2) {
		...
		if (v2.y == sarpe2.y - 1 || v2.y == sarpe2.y - 2) {
			v2.y = sarpe2.y - 3;
			okWall2 = true;
		}
		if (v2.y == sarpe2.y + 1 || v2.y == sarpe2.y + 2) {
		...
		if (v3.x == sarpe2.x - 1 || v3.x == sarpe2.x - 2) {
			v3.x = sarpe2.x - 3;
			okWall2 = true;
		}
		if (v3.x == sarpe2.x + 1 || v3.x == sarpe2.x + 2) {
		...
		if (v3.y == sarpe2.y - 1 || v3.y == sarpe2.y - 2) {
			v3.y = sarpe2.y - 3;
			okWall2 = true;
		}
		if (v3.y == sarpe2.y + 1 || v3.y == sarpe2.y + 2) {
		...
		if (v4.x == sarpe2.x - 1 || v4.x == sarpe2.x - 2) {
			v4.x = sarpe2.x - 3;
			okWall2 = true;
		}
		if (v4.x == sarpe2.x + 1 || v4.x == sarpe2.x + 2) {
		...
		if (v4.y == sarpe2.y - 1 || v4.y == sarpe2.y - 2) {
			v4.y = sarpe2.y - 3;
			okWall2 = true;
		}
		if (v4.y == sarpe2.y + 1 || v4.y == sarpe2.y + 2) {
		...
		if (v5.x == sarpe2.x - 1 || v5.x == sarpe2.x - 2) {
			v5.x = sarpe2.x - 3;
			okWall2 = true;
		}
		if (v5.x == sarpe2.x + 1 || v5.x == sarpe2.x + 2) {
		...
		if (v5.y == sarpe2.y - 1 || v5.y == sarpe2.y - 2) {
			v5.y = sarpe2.y - 3;
			okWall2 = true;
		}
		if (v5.y == sarpe2.y + 1 || v5.y == sarpe2.y + 2) {
		...
		if (v6.x == sarpe2.x - 1 || v6.x == sarpe2.x - 2) {
			v6.x = sarpe2.x - 3;
			okWall2 = true;
		}
		if (v6.x == sarpe2.x + 1 || v6.x == sarpe2.x + 2) {
		...
		if (v6.y == sarpe2.y - 1 || v6.y == sarpe2.y - 2) {
			v6.y = sarpe2.y - 3;
			okWall2 = true;
		}
		if (v6.y == sarpe2.y + 1 || v6.y == sarpe2.y + 2) {
		...
		if (v7.x == sarpe2.x - 1 || v7.x == sarpe2.x - 2) {
			v7.x = sarpe2.x - 3;
			okWall2 = true;
		}
		if (v7.x == sarpe2.x + 1 || v7.x == sarpe2.x + 2) {
		...
		if (v7.y == sarpe2.y - 1 || v7.y == sarpe2.y - 2) {
			v7.y = sarpe2.y - 3;
			okWall2 = true;
		}
		if (v7.y == sarpe2.y + 1 || v7.y == sarpe2.y + 2) {
		...
		if (v8.x == sarpe2.x - 1 || v8.x == sarpe2.x - 2) {
			v8.x = sarpe2.x - 3;
			okWall2 = true;
		}
		if (v8.x == sarpe2.x + 1 || v8.x == sarpe2.x + 2) {
		...
		if (v8.y == sarpe2.y - 1 || v8.y == sarpe2.y - 2) {
			v8.y = sarpe2.y - 3;
			okWall2 = true;
		}
		if (v8.y == sarpe2.y + 1 || v8.y == sarpe2.y + 2) {
		...
		if (v9.x == sarpe2.x - 1 || v9.x == sarpe2.x - 2) {
			v9.x = sarpe2.x - 3;
			okWall2 = true;
		}
		if (v9.x == sarpe2.x + 1 || v9.x == sarpe2.x + 2) {
		...
		if (v9.y == sarpe2.y - 1 || v9.y == sarpe2.y - 2) {
			v9.y = sarpe2.y - 3;
			okWall2 = true;
		}
		if (v9.y == sarpe2.y + 1 || v9.y == sarpe2.y + 2) {
		...
		if (v10.x == sarpe2.x - 1 || v10.x == sarpe2.x - 2) {
			v10.x = sarpe2.x - 3;
			okWall2 = true;
		}
		if (v10.x == sarpe2.x + 1 || v10.x == sarpe2.x + 2) {
		...
		if (v10.y == sarpe2.y - 1 || v10.y == sarpe2.y - 2) {
			v10.y = sarpe2.y - 3;
			okWall2 = true;
		}
		if (v10.y == sarpe2.y + 1 || v10.y == sarpe2.y + 2) {
